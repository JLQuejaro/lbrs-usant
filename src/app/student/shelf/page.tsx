    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-6 -mt-24 pb-12 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          <div className="md:col-span-4 lg:col-span-3">
            <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
              ...
              <div className="pt-12 pb-6 px-6 text-center">
                ...
                {/* Student-specific borrowing privileges */}
                <div className="border-t border-gray-100 mt-4 pt-4 text-left">
                  <div className="flex items-center gap-2 text-xs text-gray-500 mb-2">
                    <Layers size={14} className="text-gray-400" />
                    <span className="font-medium">Borrowing Limits</span>
                  </div>
                  <ul className="text-[10px] text-gray-400 space-y-1">
                    <li>• 7-day borrowing period</li>
                    <li>• Up to 5 books at once</li>
                    <li>• Renew if not overdue</li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          {/* RIGHT: Current Borrows */}
          <div className="md:col-span-8 lg:col-span-9">
             <div className="bg-white rounded-2xl shadow-sm border border-gray-100 min-h-[500px]">
                
                {/* Header */}
                <div className="border-b border-gray-100 px-6 py-4">
                  <h2 className="text-xl font-bold text-gray-900">Current Borrows ({borrows.length})</h2>
                </div>
